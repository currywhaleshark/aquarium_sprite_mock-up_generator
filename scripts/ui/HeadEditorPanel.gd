...
const NUMERIC_KEYS := {
	...
	"head_top_flatness": {"min": -1.0, "max": 1.0, "step": 0.005},
	"head_bottom_flatness": {"min": -1.0, "max": 1.0, "step": 0.005},
	"head_left_flatness": {"min": -1.0, "max": 1.0, "step": 0.005},
	"head_right_flatness": {"min": -1.0, "max": 1.0, "step": 0.005},
...
const SHARK_HEAD_RECIPES := {
	"white_shark_conical": {
		...
		"head_length": 0.50,
		"head_offset": -0.78,
		"head_flattening": 0.06,
		"shark_head_rear_height": 0.40,
		"shark_head_rear_width": 0.44,
		"snout_length": 0.18,
		"snout_base": 0.38,
		"snout_thickness": 0.84,
		"snout_taper": 0.16,
		"snout_curve": -0.14,
		"shark_snout_tip_y": 0.0,
		"forehead_slope": 0.16,
		"head_top_curve": 0.20,
		"head_top_peak": 0.60,
		"head_belly_curve": 0.20,
		"eye_size": 0.032,
		"eye_position_x": -0.94,
		"eye_position_y": 0.06,
		"eye_bulge": 0.10,
		"eye_pupil_scale": 0.62,
		"shark_mouth_profile": "predatory_u",
		"shark_mouth_position_x": -1.02,
		"shark_mouth_position_y": -0.15,
		"shark_mouth_width": 0.34,
		"shark_mouth_curve": 0.66,
		"shark_mouth_angle": -6.0,
		"shark_mouth_arc": 0.30,
		"shark_mouth_gape": 0.16,
