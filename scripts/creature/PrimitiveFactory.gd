...
static func _head_mesh_precompute(shape: String, snout_length: float, forehead_slope: float, sculpt: Dictionary) -> Dictionary:
	...
	return {
		...
		"head_top_flatness": clampf(float(sculpt.get("head_top_flatness", 0.0)), -1.0, 1.0),
		"head_bottom_flatness": clampf(float(sculpt.get("head_bottom_flatness", 0.0)), -1.0, 1.0),
		"head_left_flatness": clampf(float(sculpt.get("head_left_flatness", 0.0)), -1.0, 1.0),
		"head_right_flatness": clampf(float(sculpt.get("head_right_flatness", 0.0)), -1.0, 1.0),
